...
Premium Astro 4 static marketing site for **Rachel's Cleaning Services** (Fort Myers / San Carlos Park, FL).

**Cleaning-only branding** — no Home Watch anywhere on the live site.

## Stack

- GitHub + **Astro 4** + TypeScript
- Static output (`dist/`) → **Cloudflare Pages**
...
src/
  ...
  components/               # Header, Hero, Services, FeatureStats, FAQ, etc.
  layouts/BaseLayout.astro
  pages/index.astro
  styles/global.css
public/images/              # real photos + cleaning-only wordmark
